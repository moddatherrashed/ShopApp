                ...
                <ScrollView style={{ flex: 1.9 }}>
                    <View style={{ margin: 5, backgroundColor: '#FFFFFF', elevation: 15, marginBottom: 20, borderRadius: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', flex : 3 , alignItems : 'center'}}>
                            ...
                            <Text style={{ padding: 5, flex : 1, textAlign : 'center', fontWeight : 'bold' }}>Product Name</Text>
                            <Text style={{ padding: 5, textAlign: 'center' , flex : 1, fontWeight : 'bold', fontSize : 20}}>50 JD</Text>
                            </View>
                    ...
                    <View style={{ backgroundColor: '#FFFFFF', height: ScreenSize.height * 0.4, elevation: 15,margin : 5,borderRadius : 5 }}>
