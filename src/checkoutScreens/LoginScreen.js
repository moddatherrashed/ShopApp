            ...
            <ScrollView style={{ flex: 2 }} keyboardShouldPersistTaps="always" >
                ...
                <View style={{ flex: 1, backgroundColor: '#FFFFFF', margin: 10, elevation: 15, borderRadius: 5 }}>
                    ...
                    <Item floatingLabel style={{ flex: 0.3 }} >
                        ...
                        <Input autoCorrect={false} value={this.props.emailValue} onChangeText={this.props.onEmailChange} style={{ color: styleColors.cartScreenColors }} />
                    </Item>
                    <Item floatingLabel style={{ flex: 0.3 }} >
                        ...
                        <Input  autoCorrect={false} secureTextEntry value={this.props.passwordValue} onChangeText={this.props.onPasswordChange} style={{ color: styleColors.cartScreenColors }} />
                    </Item>
                ...
                <View style={{ flex: 1, backgroundColor: '#FFFFFF', elevation: 15, margin: 10, borderRadius: 5 }}>
                    ...
                    <Item floatingLabel style={{}} >
                        ...
                        <Input  autoCorrect={false} value={this.props.fullNameValue} onChangeText={this.props.onFullNameChanged} style={{ color: styleColors.cartScreenColors }} />
                    </Item>
                    <Item floatingLabel style={{}} >
                        <Label style={{ color: styleColors.cartScreenColors, paddingLeft: 5 }}>{I18nManager.isRTL ? strings.ar.email : strings.en.email}</Label>
                        <Input autoCorrect={false}  value={this.props.regEmailValue} onChangeText={this.props.onRegEmailChanged} style={{ color: styleColors.cartScreenColors }} />
                    </Item>
                    <Item floatingLabel style={{}} >
                        <Label style={{ color: styleColors.cartScreenColors, paddingLeft: 5 }}>{I18nManager.isRTL ? strings.ar.password : strings.en.password}</Label>
                        <Input  autoCorrect={false} value={this.props.regPasswordValue} onChangeText={this.props.onRegPasswordChanged} style={{ color: styleColors.cartScreenColors }} />
                    </Item>
                    <Item floatingLabel style={{}} >
                        ...
                        <Input autoCorrect={false} value={this.props.regRePasswordValue} onChangeText={this.props.onRegRePasswordChanged} style={{ color: styleColors.cartScreenColors }} />
                    </Item>
